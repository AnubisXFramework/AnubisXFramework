...
**AnubisX Framework — Licensing Information and Usage Guidelines**

---

## Main License

The AnubisX Framework theoretical specification is licensed under **Creative Commons Attribution 4.0 International (CC BY 4.0)**.

See [LICENSE.md](LICENSE.md) for the full license summary and link to the complete legal text.
...
When using the AnubisX Framework, please provide attribution as follows:

### Minimal Attribution

```
AnubisX Framework (2026) — https://github.com/AnubisXFramework/AnubisXFramework
CC BY 4.0
```
...
This repository may reference or incorporate third-party content. Such content remains under its original license terms. The CC BY 4.0 license applies only to original AnubisX Framework content.
