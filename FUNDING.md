...
**AnubisX Framework — Support and Funding Information**

---

## Current Funding Status

The AnubisX Framework is currently an independent research project. Information about funding sources, grants, and institutional support will be posted here as they become available.
...
| Area | Impact |
|---|---|
| **Cybersecurity** | More robust attribution of threat actors |
| **Digital Forensics** | Scientifically grounded methodology with quantified error rates |
| **Legal Standards** | Daubert-compliant evidence framework |
| **National Security** | Attribution resilient to counter-forensics |
...
All funding sources will be acknowledged in project documentation and publications. See [ACKNOWLEDGEMENTS.md](ACKNOWLEDGEMENTS.md) for current acknowledgments.
