...
The AnubisX Framework v2.0.0 includes both a complete theoretical specification and a validated prototype implementation.
...
If you identify a security-relevant issue in the framework specification, please report it by:

1. **Opening a security issue** on GitHub with the `[SECURITY]` prefix
2. **Contacting the maintainers** through the project's security contact
3. **Providing sufficient detail** to reproduce or understand the issue

### For Implementation Issues

For implementation-specific vulnerabilities:
...
The framework embeds privacy protections through the P³ Protocol (Proportionality and Privacy Protection):
...
The framework provides theoretical basis for counter-forensic resistance and addresses the cost of deliberate behavioral modification.
...
- No credentials, API keys, or secrets are hard-coded
- The prototype does not perform data exfiltration

### Known Limitations
- The prototype has not undergone formal security audit
...
The AnubisX Framework is intended for legitimate forensic, security, and research purposes conducted under appropriate legal oversight.
